...
export default function Footer() {
  return (
    <footer className="bg-background-dark" aria-labelledby="footer-heading">
        ...
        <div className="mx-auto max-w-7xl py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
          <div className="xl:grid xl:grid-cols-3 xl:gap-8">
            <div className="space-y-8">
              <div className="text-2xl font-bold text-primary">FinanceHub</div>
              <p className="text-sm leading-6 text-accent-dark">
                Making financial expertise accessible to everyone through technology and personalized service.
              </p>
              <div className="flex space-x-6">
                {navigation.social.map((item) => (
                  <a
                    key={item.name}
                    href={item.href}
                    className="text-accent-dark hover:text-primary"
                  >
          ...
          <div className="mt-12 border-t border-gray-200 pt-8">
            <p className="text-sm text-accent-dark xl:text-center">
