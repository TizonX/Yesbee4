...
const timeline = [
  ...
  },
  {
    ...
    title: "Expansion",
    description:
      "Expanded services to include investment advisory and wealth management",
    image:
    ...
    <div className="bg-background-light">
      ...
      <div className="relative overflow-hidden bg-gradient-to-b from-primary/5 via-primary/5 to-transparent h-screen">
        ...
        <div className="relative z-10 flex h-full flex-col items-center justify-center mx-auto max-w-4xl text-center px-4">
          ...
          >
            We're on a mission to make financial success accessible to everyone
      ...
      <Section className="bg-background-dark">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <motion.p
            ...
            {...fadeInUp}
          >
            At FinanceHub, we believe everyone deserves access to expert
            financial guidance. Our mission is to democratize financial services
            through technology while maintaining the personal touch that complex
            ...
            {[
              {
                title: "Mission",
                description:
                  "To empower individuals and businesses with accessible, innovative financial solutions that drive growth and security.",
                icon: (
                  <svg
                    className="h-6 w-6"
                    fill="none"
              ...
              },
              {
                title: "Vision",
                description:
                  "To be the most trusted financial technology platform, transforming how people manage and grow their wealth.",
                icon: (
                  <svg
                    className="h-6 w-6"
                    fill="none"
      ...
      <Section className="relative overflow-hidden bg-gradient-to-b from-primary/5 to-transparent">
        ...
        <div className="relative mx-auto max-w-4xl text-center">
          ...
          <motion.p
            ...
            {...fadeInUp}
          >
            Join thousands of satisfied clients who trust FinanceHub with their
            financial future.
          </motion.p>
          <motion.div
